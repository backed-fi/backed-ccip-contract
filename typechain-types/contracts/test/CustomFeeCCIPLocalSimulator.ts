...
export interface CustomFeeCCIPLocalSimulatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "configuration"
      | "getSupportedTokens"
...
export interface CustomFeeCCIPLocalSimulator extends BaseContract {
  connect(runner?: ContractRunner | null): CustomFeeCCIPLocalSimulator;
  waitForDeployment(): Promise<this>;

  interface: CustomFeeCCIPLocalSimulatorInterface;

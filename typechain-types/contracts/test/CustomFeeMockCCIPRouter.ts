...
export interface CustomFeeMockCCIPRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_GAS_LIMIT"
...
export interface CustomFeeMockCCIPRouter extends BaseContract {
  connect(runner?: ContractRunner | null): CustomFeeMockCCIPRouter;
  waitForDeployment(): Promise<this>;

  interface: CustomFeeMockCCIPRouterInterface;

...
import {CustomFeeMockCCIPRouter} from './CustomFeeMockCCIPRouter.sol';

contract CustomFeeCCIPLocalSimulator {
    ...
    CustomFeeMockCCIPRouter internal immutable i_mockRouter;
    ...
    constructor() {
        ...
        i_mockRouter = new CustomFeeMockCCIPRouter();
